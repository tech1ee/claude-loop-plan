#!/usr/bin/env bash
# loop-skills v0.6.0 — full isolated E2E test suite
...
assert_eq "$PKG_VER" "$VERSION" "installed package.json version is $VERSION"
...
assert_output_contains "$OUT11_FULL" "$VERSION" "list: shows version $VERSION"
