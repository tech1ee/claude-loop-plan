...
**Install:** `npx @loopskills/claude-skills --agents android-kmp-explorer`
...
**Install:** `npx @loopskills/claude-skills --agents android-coroutine-scope-leak-auditor`
...
**Install:** `npx @loopskills/claude-skills --agents android-fgs-compliance-auditor`
...
**Install:** `npx @loopskills/claude-skills --agents android-r8-proguard-auditor`
...
**Install:** `npx @loopskills/claude-skills --agents android-baseline-profile-checklister`
