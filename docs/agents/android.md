...
**Install:** `npx loop-skills --agents android-kmp-explorer`
...
**Install:** `npx loop-skills --agents android-coroutine-scope-leak-auditor`
...
**Install:** `npx loop-skills --agents android-fgs-compliance-auditor`
...
**Install:** `npx loop-skills --agents android-r8-proguard-auditor`
...
**Install:** `npx loop-skills --agents android-baseline-profile-checklister`
