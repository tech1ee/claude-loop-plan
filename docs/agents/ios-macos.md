...
**Install:** `npx loop-skills --agents swiftui-explorer`
...
**Install:** `npx loop-skills --agents ios-appstore-preflight-auditor`
...
**Install:** `npx loop-skills --agents ios-codable-edge-auditor`
...
**Install:** `npx loop-skills --agents ios-coredata-migration-auditor`
...
**Install:** `npx loop-skills --agents kmp-bridging-topology-auditor`
...
**Install:** `npx loop-skills --agents kmp-swift-interop-readiness-auditor`
...
**Install:** `npx loop-skills --agents macos-entitlements-distribution-auditor`
...
**Install:** `npx loop-skills --agents macos-notarization-preflight-auditor`
...
**Install:** `npx loop-skills --agents macos-appkit-swiftui-interop-auditor`
