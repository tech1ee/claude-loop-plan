...
**Install:** `npx loop-skills --agents react-nextjs-explorer`
...
**Install:** `npx loop-skills --agents react-hooks-misuse-auditor`
...
**Install:** `npx loop-skills --agents nextjs-rsc-boundary-auditor`
